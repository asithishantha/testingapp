...
public class FiltersListFragment extends Fragment implements FiltersListFragmentListener {
    ...
    public void setThumbnailItems(List<ThumbnailItem> thumbnailItems) {
